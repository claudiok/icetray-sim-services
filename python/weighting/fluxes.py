...
class CompiledFlux(object):
	...
	def __init__(self, expr):
		...
		# by default, assume CORSIKA codes
	...
	def to_PDG(self):
		...
		"""
		new = copy.copy(self)
		if CompiledFlux.pdg_to_corsika is None:
			import numexpr
			CompiledFlux.pdg_to_corsika = numexpr.NumExpr(self.build_lookup([(int(PDGCode.from_corsika(v)), v) for v in ParticleType.values.keys()]))
